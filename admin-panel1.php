...
if(isset($_POST['patientsub1']))
{
  $decontact=$_POST['decontact'];
  $query="delete from patreg where contact='$decontact';";
  $result=mysqli_query($con,$query);
  if($result)
    {
...
<html lang="en">
  <head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
      ...
      <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> MSM Hospital </a>
      ...
      <style >
        .bg-primary {
          background: -webkit-linear-gradient(left, #378a97, #74c5d2);
        }
        ...
        <div class="tab-content" id="nav-tabContent" style="width: 950px;">
          <div class="tab-pane fade show active" id="list-dash" role="tabpanel" aria-labelledby="list-dash-list">
            <div class="container-fluid container-fullw bg-white">
              <div class="row">
                  ...
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-doc" onclick="clickDiv('#list-doc-list')" style="color:#337179">
                          View Doctors
                        </a>
                      </p>
                    </div>
                ...
                <div class="col-sm-4" style="left: -7%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-pat-list')"style="color:#337179">
                          View Patients
                        </a>
                      </p>
                    </div>
                ...
                <div class="col-sm-4" style="left: -11%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-app-list')" style="color:#337179">View Appointments</a>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div class="row">
                <div class="col-sm-4" style="margin-top: 5%;">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <p class="cl-effect-1">
                        <a href="#list-pres" onclick="clickDiv('#list-pres-list')" style="color:#337179">
                          View Prescriptions
                        </a>
                      </p>
                    </div>
                ...
                <div class="col-sm-4" style="left: -7%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      ...
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-adoc-list')" style="color:#337179">Add Doctors</a>
                        &nbsp|
                        <a href="#app-hist" onclick="clickDiv('#list-ddoc-list')" style="color:#337179">Delete Doctors</a>
                      </p>
                    </div>
                  </div>
                </div>

                <div class="col-sm-4" style="left: -11%;margin-top: 5%">
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body" >
                      <span class="fa-stack fa-2x"> <i class="fa fa-square fa-stack-2x text-primary"></i> <i class="fa fa-plus fa-stack-1x fa-inverse"></i> </span>
                      ...
                      <p class="cl-effect-1">
                        <a href="#app-hist" onclick="clickDiv('#list-dpat-list')" style="color:#337179">Delete Patients</a>
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
            <form class="form-group" method="post" action="admin-panel1.php">
              ...
              <br><br>
              <input type="submit" name="docsub" value="Add Doctor" class="btn btn-primary col-md-2">
            </form>
          </div>
          ...
          <div class="tab-pane fade" id="list-settings1" role="tabpanel" aria-labelledby="list-settings1-list">
            <form class="form-group" method="post" action="admin-panel1.php">
              <div class="row" style="margin:auto; margin-top:40px; padding-bottom: 15px;"> 
                <div class="col-md-4" style="margin-left:auto;padding-top: 15px;"><label>Email ID:</label></div>
                <div class="col-md-8" style="margin:auto;"><input type="email" class="form-control" name="demail" required></div><br><br>
              </div>
              <br><br>
              <div class="row" style="margin-right:auto;"> 
                <div class="col-md-4" style="margin:auto;"><input type="submit" name="docsub1" value="Delete Doctor" class="btn btn-primary" onclick="confirm('do you really want to delete?')"></div>
              </div>
            </form>
          </div>
          ...
          <div class="tab-pane fade" id="list-settings2" role="tabpanel" aria-labelledby="list-settings2-list">
            <form class="form-group" method="post" action="admin-panel1.php">
              <div class="row" style="margin:auto; margin-top:40px;"> 
                <div class="col-md-4" style="margin-left:auto; padding-top: 15px;"><label>Contact:</label></div>
                <div class="col-md-8" style="margin:auto;"><input type="contact"  class="form-control" name="decontact" required></div><br><br>
              </div>
              <br><br>
              <div class="row" style="margin:auto;"> 
                <div class="col-md-4" style="margin:auto;"><input type="submit" name="patientsub1" value="Delete Patient" class="btn btn-primary" onclick="confirm('do you really want to delete?')"></div>
              </div>
            </form>
          </div>
