...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> MSM Hospitals</h2></br>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav" style= "margin-left: auto;">
          <li class="nav-item">
            <a class="nav-link" style="margin:right" href="logout.php">Logout</a>
          </li>
          <li class="nav-item">
                    ...
                    <div class="panel panel-white no-radius text-center">
                      <div class="panel-body">
                        ...
                        <p class="links cl-effect-1">
                          <a href="#list-home" onclick="clickDiv('#list-home-list')" style="color:#337179">
                            Book Appointment
                          </a>
                        </p>
                      </div>
                        ...
                        <!-- <script>
                          let data = 
                            ...
                            document.getElementById('spec').onchange = function updateSpecs(e) {
                              et values = data.filter(obj => obj.spec == this.value).map(o => o.username);   
