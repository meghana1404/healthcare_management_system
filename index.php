<html>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-45px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp MSM HOSPITALS</h4></a>
        ...
        <div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
            <div class="register-top" style="margin-top: 1%; align: center;">
                <h3>Welcome !</h3>
            </div>
            <div class="row">
                <div class="col-md-9 register-right" style="margin-top: 40px;">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <h3 class="register-heading"><br>Register as Patient</h3>
                        ...
                        <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                            <h3  class="register-heading"><br>Login as Doctor</h3>
                        ...
                        <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                            <h3  class="register-heading"><br>Login as Admin</h3>
