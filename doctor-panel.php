...
if(isset($_GET['cancel']))
  ...
  {
    $query=mysqli_query($con,"update appointmenttb set presbstatus='1' where ID = '".$_GET['ID']."'");
    if($query)
    {
      echo "<script>alert('Your appointment successfully completed');</script>";
    }
  }
  ...
  <head>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
      ...
      <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <form class="form-inline my-2 my-lg-0" style="margin-left:auto;" method="post" action="search.php">
                  ...
                  <div class="panel panel-white no-radius text-center">
                    <div class="panel-body">
                      ...
                      <p class="links cl-effect-1">
                        <a href="#list-app" onclick="clickDiv('#list-app-list')" style="color:#337179">
                          Appointment List
                        </a>
                      </p>
                    </div>
