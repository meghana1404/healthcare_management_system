...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav" style= "margin-left: auto;">
          ...
          <li class="nav-item">
            <a class="nav-link" href="logout1.php"></i>Logout</a>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <body style="padding-top:50px;">
    <div class="container-fluid" style="margin-top:30px;">
      <h3 style = "margin-left: 40%;  padding-bottom: 15px; font-family: 'IBM Plex Sans', sans-serif;"> Welcome &nbsp<?php echo $doctor ?></h3>

      <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" name="prescribeform" method="post" action="prescribe.php">
          <div class="row" style="margin:auto;">
            <div class="col-md-2" style="margin:auto;"><label>Disease:</label></div>
            ...
            <div class="col-md-2" style="margin:auto;"><label>Allergies:</label></div>
            ...
            <div class="col-md-2" style="margin:auto;"><label>Prescription:</label></div>
